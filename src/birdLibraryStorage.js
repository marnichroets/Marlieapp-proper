...
// any custom birds that aren't in the bundle. Every other (unseen) bird is
...
// overlay the saved per-user data for that id, then append any custom saved
...
// user data / sighting enrichment) plus custom birds not in the bundled catalog
