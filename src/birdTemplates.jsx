...
export function SongbirdSmall({ zones, size = 160, ground = true, flying = false }) {
  return (
...
export function SongbirdCrested({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export function Weaver({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
// (sunbird, sugarbird)
export function Sunbird({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export function Kingfisher({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
// (barbet, tinkerbird)
export function Barbet({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export function Longtail({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export function Swallow({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export function Dove({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export function Waterbird({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export function Raptor({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export function Starling({ zones, size = 160, ground = true, flying = false }) {
  return (
    <svg viewBox="0 0 620 460" style={{ width: size, height: size * (460 / 620), ...ZoneStyle({ zones }) }} xmlns="http://www.w3.org/2000/svg">
      <defs>
...
// twig through the sky. `flying={true}` hides the legs/feet and tags the
// wing with the CSS flap animation (see garden-bird-wingflap in App.css).
export function GardenBird({ template, zones, size = 160, ground = true, flying = false }) {
  const Template = BIRD_TEMPLATES[template] || SongbirdSmall
  return <Template zones={zones} size={size} ground={ground} flying={flying} />
}
